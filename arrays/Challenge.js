...
let alivePres = presidents.filter((presidents) => presidents.passed === undefined);
console.log(alivePres); // Works
let deceasedPres = presidents.filter((presidents) => presidents.passed != undefined);
console.log(deceasedPres); // Works
